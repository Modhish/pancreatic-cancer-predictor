...
# Attach the commentary and reporting helpers to the risk assessment system class.
MedicalDiagnosticSystem.generate_clinical_commentary = generate_clinical_commentary
MedicalDiagnosticSystem.generate_shap_chart_explanations = generate_shap_chart_explanations
...
# Initialize the singleton risk assessment system instance used across the app.
